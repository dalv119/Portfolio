...
class OrderDdsBuilder:
    ...
    def s_order_cost(self) -> S_OrderCost:
        ...
        return S_OrderCost(
            hk_order_cost_hashdiff=self._uuid(f"{order_id}#$#{cost}#$#{payment}"),
            h_order_pk=self._uuid(order_id),
            cost=cost,
            payment=payment,
            load_dt=datetime.utcnow(),
    ...
    def s_product_names(self) -> List[S_ProductNames]:
        ...
        for prod_dict in self._dict['products']:
            ...
            prod_names.append(
                S_ProductNames(
                    hk_product_names_hashdiff=self._uuid(f"{prod_id}#$#{name}"),
                    h_product_pk=self._uuid(prod_id),
                    name=name,
                    load_dt=datetime.utcnow(),
                    load_src=self.source_system
...
class DdsRepository:
    ...
    def dds_h_user(self, user: H_User) -> None:
    ...
    def dds_h_product(self, obj: H_Product) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_h_category(self, obj: H_Category) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_h_restaurant(self, obj: H_Restaurant) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_h_order(self, obj: H_Order) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_l_order_product(self, obj: L_OrderProduct) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_l_product_restaurant(self, obj: L_ProductRestaurant) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_l_product_category(self, obj: L_ProductCategory) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_l_order_user(self, obj: L_OrderUser) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_s_user_names(self, obj: S_UserNames) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_s_restaurant_names(self, obj: S_RestaurantNames) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_s_product_names(self, obj: S_ProductNames) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_s_order_cost(self, obj: S_OrderCost) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def dds_s_order_status(self, obj: S_OrderStatus) -> None:
        with self._db.connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
                    ...
                    """,
                    {
                        'hk_order_status_pk': obj.hk_order_status_hashdiff,
                        'h_order_pk': obj.h_order_pk,
                        'status': obj.status,
                        'load_dt': obj.load_dt,
                        'load_src': obj.load_src
