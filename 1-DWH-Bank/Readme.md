# Cоздание хранилища DWH (SCD2) с ветриной данных по мошенническим операциям
...
## Общий вывод
- Создано хранилище DWH с инкрементальной загрузкой методом SCD2 c витринами данных которое позволяет отловить операции с признаками мошеннических
--------------------------
### Структура хранилища.
