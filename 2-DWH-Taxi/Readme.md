...
строящий отчет.
настроить ETL процесс, который будет забирать данные
из источника и раскладывать их по целевым таблицам в описанную в документации
структуру в хранилище.
получить бизнес-результат по данным, загруженным в хранилище. Для этого требуется составить четыре отчета

## Задачи проекта
Создать витрины отчетов:
1. Выплата водителям
